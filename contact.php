        ...
        <div class="container py-5">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p class="m-0">
                        Home &nbsp;<i class="fas fa-arrow-right"></i> &nbsp;Contact
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-8">
                <div class="row form-contact">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control mb-4" placeholder="Enter your subject">
                    </div>
                    <div class="col-md-6">
                        <textarea class="form-control pb-5 mb-4" id="exampleFormControlTextarea1" rows="7" placeholder="Message"></textarea>
                        <a href="" class="float-right">Send Message</a>
                    </div>
                </div>
            </div>
        </div>
