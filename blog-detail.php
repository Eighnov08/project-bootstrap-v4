                            ...
                            <?php if($total_page > 1) {?>
                                <nav aria-label="...">
                                    <ul class="pagination justify-content-center">
                                        <?php if($cur_page > 1) {?>
                                            <li class="page-item">
                                                <a class="page-link" href="index.php?blog-detail=<?php echo $row_detail["id"] ?>&page_detail=<?php echo $cur_page - 1 ?>#page"><i class="fas fa-chevron-left"></i></a>
                                            </li>
                                        <?php } else { ?>
                                        ...
                                        <?php for($i=1; $i<=$total_page; $i++){ ?>
                                            <?php if($i==$cur_page){ ?>
                                                <li class="page-item active" aria-current="page"><a class="page-link"  href="index.php?blog-detail=<?php echo $row_detail["id"] ?>&page_detail=<?php echo $i ?>#page"><?php echo $i ?></a></li>
                                            <?php } else { ?>
                                                <li class="page-item"><a class="page-link" href="index.php?blog-detail=<?php echo $row_detail["id"] ?>&page_detail=<?php echo $i ?>#page"><?php echo $i ?></a></li>
                                            <?php } ?>
                                        <?php } ?>
                                        <?php if($cur_page < $total_page) {?>
                                            <li class="page-item">
                                                <a class="page-link" href="index.php?blog-detail=<?php echo $row_detail["id"] ?>&page_detail=<?php echo $cur_page + 1 ?>#page"><i class="fas fa-chevron-right"></i></a>
                                            </li>
                                        <?php } else { ?>
                                            <li class="page-item disabled">
